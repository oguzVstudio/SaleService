...
{
    public class SaleDetailTableRepository : Repository<SaleDetailTable>, ISaleDetailTableRepository
    {
        public SaleDetailTableRepository(ApplicationDbContext context) : base(context)
        {
        }
